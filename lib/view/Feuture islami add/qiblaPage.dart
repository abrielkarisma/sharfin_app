...
class _QiblahScreenState extends State<KiblatPage> with SingleTickerProviderStateMixin {
  @override
  void initState() {
        ...
        body: StreamBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              return Container(alignment: Alignment.center, child: const CircularProgressIndicator(color: Colors.black,));  
            }
